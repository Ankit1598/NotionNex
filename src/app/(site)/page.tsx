		...
		<>
			<div className='py-10'>
				<section className='overflow-hidden px-4 sm:px-6 sm:flex sm:flex-col gap-4 md:justify-center md:items-center'>
					...
					/>
					<div className='bg-white p-1 mt-6 rounded-xl bg-gradient-to-r from-primary to-brand-primaryBlue sm:w-[300px]'>
						<Button
				...
				<section className='px-4 sm:px-6 flex justify-center items-center flex-col relative'>
					...
					<TitleSection
						...
						pill='Features'
					/>
					<div className='mt-10 max-w-[450px] flex justify-center items-center relative sm:ml-0 rounded-2xl border-8 border-washed-purple-300border-opacity-10'>
				...
				<section className='relative'>
					...
					<div className='mt-20 px-4 sm:px-6 flex flex-col overflow-x-hidden overflow-visible'>
						<TitleSection
							...
							subtitle='Join thousands of satisfied users who rely on our platform for their personal and professional productivity needs.'
							pill='Testimonials'
						/>
